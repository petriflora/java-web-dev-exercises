...
public class Program {
    public static void main(String[] args){
        ...
        System.out.println("ID#: C" + acer.createID());
        ...
        System.out.println("ID#: C" + acer2.createID());
        ...
        System.out.println("ID#: SP" + iPhone10.createID());
        ...
        System.out.println("ID#: SP" + iPhone11.createID());
        ...
        System.out.println("ID#: SP" + iPhone12.createID());
